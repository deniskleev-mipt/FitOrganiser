...
- (IBAction)send:(id)sender {
    if ([MFMailComposeViewController canSendMail]) {
        ...
        NSString *subjectString = [NSString stringWithFormat:@"Напоминание по почте"];
        [controller setSubject:subjectString];
        NSString *messagebodyString = [NSString stringWithFormat:@"Моя почта:   \nПожалуйста, напомните мне о начале действия функии ''Fitman''."];
